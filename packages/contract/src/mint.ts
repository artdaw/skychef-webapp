...
import { NFT_METADATA_SPEC, NFT_STANDARD_NAME } from "./meta";
import { Token, TokenMetadata } from "./meta";
...
export function internalMint({
    ...
    const requiredStorageInBytes = near.storageUsage().valueOf() - initialStorageUsage.valueOf();
